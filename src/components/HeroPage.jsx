    ...
    return(
        <div className={`${styles.boxContainer}`}>
            ...
            <div className={`${styles.image}`}>
                <img className={`${styles.a}`} src={image1} alt="bank"></img>
            </div>
            ...
            <div className={`${styles.loginContainer2}`}>
                <div className={`${styles.image}`}>
                    <img className={`${styles.b}`} src={image2} alt="transaction"></img>
                </div>
            <div className={`${styles.content}`}>
                    <h4>EASIER</h4>
            ...
            <div className={`${styles.box2}`}>
                <div className={`${styles.image}`}>
                    <img className={`${styles.c}`} src={image3} alt="fasterPayments"></img>
                </div>
